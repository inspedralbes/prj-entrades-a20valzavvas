...
Informe agregat de vendes per categoria de preu, accessible des del panell d'administració (`/admin`). Mostra per cada `PriceCategory`: nom, preu unitari, total de seients, seients venuts, percentatge d'ocupació i recaptació total.
