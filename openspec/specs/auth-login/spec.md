...
Gestió de l'autenticació d'usuaris mitjançant l'endpoint `POST /api/auth/login`. Permet validar credencials, generar tokens Sanctum i verificar el comportament via tests de feature de Laravel.
