...
Especificació de l'scaffold del servei NestJS (`node-service`) dins del monorepo. Cobreix la configuració del workspace pnpm, els mòduls base, les dependències real-time, la configuració d'entorn, el framework de tests Vitest i la resolució de l'àlies `@shared/*`.
