...
Navegació i cross-links entre les pàgines d'autenticació (`/auth/login`, `/auth/register`) i la portada. Inclou estils visuals coherents amb el design system cinema fosc.
