...
El sistema SHALL proporcionar un seed de base de dades que pobli l'entorn de desenvolupament i test amb dades inicials representatives: un event de prova, categories de preu, seients i usuaris. El seed ha de ser idempotent (segur d'executar múltiples vegades) i completar-se en un temps raonable.
