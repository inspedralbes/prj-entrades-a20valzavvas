...
Alliberament voluntari de seients reservats. Un Comprador autenticat pot alliberar un seient que ell mateix té reservat via WebSocket. L'alliberament és atòmic (DB transaction + lockForUpdate) i notifica tots els clients de la sala en temps real.
