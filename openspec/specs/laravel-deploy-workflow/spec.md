# Spec: laravel-deploy-workflow

## Purpose

Defineix el comportament del workflow de CI/CD per desplegar el Laravel Service al VPS de producció. Cobreix els triggers d'activació, la detecció de canvis als paths rellevants, el build de la imatge Docker multi-stage i el desplegament via SSH sense secrets hardcodejats.
