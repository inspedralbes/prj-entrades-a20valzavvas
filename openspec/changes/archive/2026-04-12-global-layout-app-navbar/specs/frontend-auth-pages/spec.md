...
#### Scenario: Formulari centrat verticalment dins del main amb navbar present

- **GIVEN** un Visitant a `/auth/login` amb la navbar global muntada
- **WHEN** la pàgina carrega
- **THEN** el formulari `.auth-card` apareix centrat verticalment dins de l'àrea `<main>` (no des del top absolut del viewport)
- **THEN** NO hi ha solapament entre la navbar i el formulari
...
- **GIVEN** un Visitant a `/auth/register` amb la navbar global muntada
- **WHEN** la pàgina carrega
- **THEN** el formulari `.auth-card` apareix centrat verticalment dins de l'àrea `<main>`
- **THEN** NO hi ha solapament entre la navbar i el formulari
