...
const backUrl = computed(() =>
  seientStore.event?.slug
    ? `/events/${seientStore.event.slug}`
    : "/",
);
  ...
  <div class="checkout-page">
    <div class="checkout-container">
      ...
      <div v-if="orderConfirmed" class="confirmation-card">
        ...
        <h1 class="confirmation-title">Compra completada!</h1>
        <p class="confirmation-text">
          Les teves entrades han estat reservades amb èxit.
        </p>
        <p class="confirmation-order-id">Referència: {{ orderId }}</p>
        <NuxtLink to="/" class="btn-primary">Tornar a la portada</NuxtLink>
      </div>
